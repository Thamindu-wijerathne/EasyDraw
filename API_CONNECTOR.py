...
def picGenarate():
    ...
    responseP2T = model.generate_content(["what is this, describe these with words separeted using , also add these into end of text 'high detail, sharp focus, 1024 X 720'", organ])
